...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = round((num_min_workers[num_min_workers['salary'] == '>50K'].shape[0] / num_min_workers['salary'].shape[0])* 100,1)
    ...
    higher_earning_indian = df[(df['salary'] == '>50K') & (df['native-country'] == 'India')].groupby('occupation')['occupation'].count()
    top_IN_occupation = higher_earning_indian.idxmax()
